...
class ContextTree:
    ...
    '''
    def __init__(self, history_maxlen = 50, nb_candidates = 1000, expert = eval('StdExpert'), session_key = 'SessionId', item_key = 'ItemId', time_key = 'Time'):
