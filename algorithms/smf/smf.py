        ...
        for j in range( self.epochs ):
            ...
            while not finished:
                ...
                for i in range(self.batch):
                    # print(i)
                    # print(self.sessions[ sidx[i] ])
                    # print(self.session_map[ self.sessions[ sidx[i] ] ])
...
#                 hit += ( (preds.T > val_pos).sum(axis=0) < 20 ).sum()
    ...
    def predict_next( self, session_id, input_item_id, predict_for_item_ids, current_session_length, row, skip=False, type='view', timestamp=0 ):
        '''
